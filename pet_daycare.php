...
<head>
    ...
    <body>
        ...
        $name = $breed = $age = $start = $end  = $from_time =$to_time="" ;
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
            ...
            $con = mysqli_connect("localhost","root","","pet_care");                      
			        ...
			        $query = "INSERT INTO `daycare` ( petname,petbreed, petage, start ,  end,from_time,to_time) VALUES ( '$name', '$breed', '$age', '$start' ,'$end', '$from_time','$to_time')";
