...
<head>
    ...
    <body>
        ...
        <?php
        session_start();
        $name = $breed = $age = $checkin = $checkout = "" ;
        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
            ...
            $con = mysqli_connect("localhost","root","","pet_care");                      
			        ...
			        $query = "INSERT INTO `boarding` (petname,petbreed, petage,checkin, checkout, user_email ) VALUES ( '$name', '$breed', '$age', '$checkin' , '$checkout','$user_email')";
